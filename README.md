...
[![My Skills](https://skillicons.dev/icons?i=py,pytorch,cs,dotnet,java,cpp,c,nodejs,elysia,express,html,css,bun,postgres,bash,git,powershell,pnpm,jenkins,kubernetes,docker,gcp,firebase,react,ts,threejs,tailwind,flutter,dart,git,linux,vscode,visualstudio,pycharm&perline=17)](https://skillicons.dev)
